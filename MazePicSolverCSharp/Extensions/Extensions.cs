...
namespace MazePicSolverCSharp
{
    ...
    {
        public static T GetPoint<T>(this T[][] items, Point point)
        {
        ...
        public static IEnumerable<Point> GetAroundArrayOfArrays<T>(this T[][] arrayOfArrays, Point pos)
        {
            return new[]
                {
                    new Point(pos.X - 1, pos.Y), new Point(pos.X + 1, pos.Y), new Point(pos.X, pos.Y - 1),
